...
import { ReleaseDetailResponse, isValidReleaseNumber } from "@/types/release";
...
export const EditReleaseModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Edit skeleton release">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-3">
          <label htmlFor="editReleaseNumber" className="block text-sm font-semibold text-blue-900">
            Release Number
          </label>
          <div className="relative">
            <Input
              id="editReleaseNumber"
              value={releaseNumber}
              onChange={(e) => {
